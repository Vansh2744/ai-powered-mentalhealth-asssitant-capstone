...
async function speak(text: string, lang = "en"): Promise<void> {
  try {
    const res = await fetch(`${backendUrl}/exercises/tts`, {
      method: "POST",
...
function ExerciseCard({
  ...
  return (
    ...
    >
      <div
        className="absolute left-0 top-4 bottom-4 w-1 rounded-full transition-all
      ...
      <div className="pl-4">
        <div className="flex items-start justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3
                className="font-bold text-slate-800 text-sm tracking-wide"
          ...
          <span
            className="text-[0.6rem] text-slate-400 shrink-0 mt-1 tracking-widest
  ...
  return (
    <div className="flex flex-col gap-6">
        ...
        <div className="text-center">
          <p className="text-xs text-slate-400 tracking-widest uppercase">
            {stage === "intro"
              ...
              : stage === "outro"
                ? "Finishing..."
                : `Round ${roundIndex + 1} of ${exercise.rounds}`}
          </p>
        </div>
        <button
      ...
      <div className="text-center">
        ...
        <h2
          className="text-xl font-black text-slate-800 mt-2"
          style={{ fontFamily: "'Syne', sans-serif" }}
        >
          {exercise.title}
        </h2>
      ...
      {stage === "running" && (
        <div className="text-center flex flex-col gap-2">
          <span
            className="text-xs font-bold tracking-[0.25em] uppercase px-4 py-1.5
...
export default function Exercises() {
  ...
  const allTags = [
    "all",
    ...Array.from(new Set(exercises.flatMap((e) => e.target))),
  ];
  ...
  return (
    <div
      className="min-h-screen w-full text-slate-800 flex flex-col items-center
        ...
        {activeExercise ? (
          ...
          <>
            ...
            <div className="mb-8">
              ...
              <h1
                className="text-3xl font-black tracking-wide text-slate-800"
                style={{ fontFamily: "'Syne', sans-serif" }}
              >
                Exercises
              </h1>
            ...
            <p
              className="text-center text-[0.55rem] text-slate-300 tracking-[0.3em]
              uppercase mt-10"
            >
